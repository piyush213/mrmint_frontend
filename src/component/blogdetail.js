...
import { TwitterShareButton, TwitterIcon, FacebookShareButton, FacebookIcon, TelegramShareButton, TelegramIcon, RedditShareButton, RedditIcon, WhatsappShareButton, WhatsappIcon } from 'react-share';
...
const Blogdetail = () => {
    ...
    const getblogid = async () => {
        ...
        if (res.success) {
            ...
            let data = res.data[0];
            setForm((old) => {
                return { ...old, "id": id, 'previewImage': config.imageUrl + data.image, 'title': data.title, 'introduction': data.introduction, 'description': data.description, 'created_at': data.created_at }
            })
        }
    }
    ...
    return (
        <>
            ...
            <div id="content">
                <div className="breadcrumb-wrap bg-f br-4">
                    ...
                    <div className="container">
                        <div className="breadcrumb-title">
                            ...
                            <ul className="breadcrumb-menu list-style mt-4">
                                <li>
                                    <a href="#">Home</a>
                                </li>
                                <li>Blog Detail</li>
                ...
                <section className="mr-blog-details pt-5">
                    <div className="container">
                        <div className="row gx-5">
                            <div className='col-sm-12 col-md-12 mb-3'>
                                <div dangerouslySetInnerHTML={{ __html: form.introduction }} />
                            </div>
                                        ...
                                        {getRecntuserbloglist.map(data => (
                                            <div className='media mr-blogrecent-item'>
                                                ...
                                                <div className="mr-blogrecent-content">
                                                    <h6>
                                                        <a href={`${config.baseUrl}Blogdetail/` + data.title_url} className='links'>
                                                            {data.title}
                                                        </a>
                                                    </h6>
                                                    <span className='time'>
