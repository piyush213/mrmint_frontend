                            ...
                            <div className='container'>
                                <div className='row'>
                                    <div className='col-lg-12'>
                                            ...
                                            <div className='row'>
                                                    ...
                                                    <div className='profile'>
                                                        ...
                                                        {image_preview ?
                                                            ...
                                                            !userDetails?.profile_pic || userDetails?.profile_pic == undefined || userDetails?.profile_pic == 'undefined' ?
                                                                <img style={{ height: '190px', width: '190px', objectFit: 'cover' }} src="images/default-user-icon.jpg" alt='' className='d-profile-img-edit img-fluid' />
                                                                :
                                                                <img style={{ height: '190px', width: '190px', objectFit: 'cover' }} src={`${config.imageUrl + userDetails?.profile_pic}`} alt='' className='d-profile-img-edit img-fluid' />
                                                        }
                                                ...
                                                <div className='col-lg-9'>
                                                    <div className='form-group mb-3'>
                                                        ...
                                                        <input type="text" onPaste={handleChange} onKeyPress={(event) => {
                                            if (
                                                /[!^*()+=\-\[\]\/{}|:'`";<>?]/.test(
                                                    event.key
                                                )
                                        ...
                                        }}  name='first_name' onChange={inputHandler} placeholder='Enter first name' value={userDetails?.first_name ? userDetails?.first_name : ''} className='form-control' />
                                                    </div>
                                            ...
                                            if (
                                                ...
                                                event.preventDefault();
                                                    ...
                                                    <div className='form-group mb-3'>
                                                        ...
                                                        <textarea type="text" name='bio' onPaste={handleChange} onKeyPress={(event) => {
                                            if (
                                                /[!^*()+=\-\[\]\/{}|:'`";<>?]/.test(
                                                    event.key
                                                )
                                        ...
                                        }}  onChange={inputHandler} placeholder='Tell the world who you are!' className='form-control' value={userDetails?.bio ? userDetails?.bio : ''} />
                                                    </div>
